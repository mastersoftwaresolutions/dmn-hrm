...
router.get('/list', function(req, res) {
		...
		req.getConnection(function(err,conn){
			if (err) return next("Cannot Connect");
				 var query = conn.query('SELECT * FROM employee',function(err,rows){ console.log("Err" , err , "Response " , rows);
				if(err){
				console.log(err);
				return next("Mysql error, check your query");
				}
...
router.post('/initiatejoining/', function(req, res) { 
				...
				status:'pending',
		        hr:'{"reponsibleperson":,"updated_employee":0,"Added_to_Address_Book":0,"Added_to_Biometric":0,"MSS_Team_Folder":0}',
		        hr_document:'{"docresponsible":,"Offer_Letter":0,"Qualification":0,"ID_Proof":0,"Experience":0,"Address_Proof":0,"Medical":0,"Date_of_Birth":0,"Bank":0,"Training_Certificate":0,"Joining":0,"Salary_Slips":0,"Code_of_Conduct":0,"Passport_size":0,"Employee_Agreement":0,"Acknowledgement":0}',
		        rbd:'{"rrbdresponsible":,"Create_Biddle":0,"Cover_Letter":0,"Google":0}',
		        network:'{"netresponsible":,"Added_static":0,"Gmail_Id":0,"Created_Skype":0,"Redmine":0,"Bitbucket":0,"Git":0,"Dropbox":0,"Local_Database":0,"Local_ftp":0}'
		     };
